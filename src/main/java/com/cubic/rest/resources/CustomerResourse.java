...
public class CustomerResourse {
	...
	private final static Logger logger = LoggerFactory.getLogger(CustomerResourse.class);
	@Autowired
	...
	public Response create(final CustomerVO customer) {
		logger.debug("Entering CustomerResourse.create");
		logger.info("Input CustomerVO = {}" + customer);
		CustomerVO result = cs.createCustomer(customer);
		logger.debug("Exiting CustomerResourse.create");
		logger.info("Input CustomerVO = {}" + result);
